...
public class ModConditions {
    ...
    public static final ConditionFactory<Pair<World, ItemStack>> ENCHANTABILITY = new ConditionFactory<>(new Identifier(TouhouOrigins.MOD_ID, "enchantability"), new SerializableData()
            .add("comparison", ApoliDataTypes.COMPARISON)
            .add("compare_to", SerializableDataTypes.INT),
            (data, pair) -> {
